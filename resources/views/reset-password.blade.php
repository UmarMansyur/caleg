              ...
              <div class="card-body p-4">
                ...
                <div class="p-2 mt-4">
                  ...
                  <form action="{{ route('ResetPassword') }}" method="post">
                    @csrf
                    <div class="mb-3">
                      <label class="form-label" for="useremail">Password Baru</label>
                      <div class="input-group input-group-merge">
                        <input type="password" id="password-input" class="form-control" placeholder="Masukkan Password" name="password" required autofocus>
                        <input type="hidden" name="token" value="{{ $token }}">
                        <button class="btn btn-light" type="button" id="password-addon"><i class="mdi mdi-eye"></i></button>
                    </div>
