  ...
  <div class="col-xxl-12">
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="overview" role="tabpanel">
        <div class="card">
          <div class="card-body">
            <h5 class="font-size-16 mb-3">Perolehan Suara Calon - (TPS 01)</h5>
            <div class="mt-3">
            ...
            <div class="mt-4">
              <h5 class="font-size-16 mb-4">Suara Calon DPR RI: </h5>
                ...
                <table class="table table-nowrap table-hover mb-1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <h5 class="font-size-14 mb-1">H. M. Fadli Imammuddin</h5>
                      </td>
                      <td>
                        250
                      </td>
              ...
              <h5 class="font-size-16 mb-4 mt-5">Suara Calon DPD: </h5>
              <div class="table-responsive">
                <table class="table table-nowrap table-hover mb-1">
                  <thead class="bg-light">
                    <tr>
